...
import com.proyecto.irp.ui.ventareporte.LibroVentaViewModel;
...
public class LibroCompraFragment extends Fragment {
    ...
    private LibroCompraViewModel libroCompraViewModel;
    Button btnverpdf,btnabrirpdf;
    String ejercicioactual;

    List<ReporteLibroCompra> libroCompras = new ArrayList<>();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view =inflater.inflate(R.layout.libro_compra_fragment, container, false);
   ...
   private ArrayList<String[]> getFacturaCompra(String desde, String hasta){
        //INSTANCIAR EL VIEW MODEL
        libroCompraViewModel = ViewModelProviders.of(this).get(LibroCompraViewModel.class);

        libroCompras = libroCompraViewModel.getLibroCompra(managerUsuario.ObtenerDatos().getIdcontribuyente(),
        ...
        /*private String[] header = {"Fecha","Ruc","Nombre","Tipo Doc.","Nro. Factura","Exenta","Gravada 5",
                "Iva 5","Gravada 10","Iva 10","Total"};*/
        for (ReporteLibroCompra riva: libroCompras){
            rows.add(new String[]{riva.getFechaventaformato(),riva.getRucproveedor(),riva.getProveedor(),
            riva.getTipodocumento(),riva.getNrofacturacompra(),
                    separadormil(riva.getExenta_compra()),
                    separadormil(riva.getGravada5_compra()),separadormil(riva.getIva5_compra()),
                    separadormil(riva.getGravada10_compra()),separadormil(riva.getIva10_compra()),
                    separadormil(riva.getTotal_compra())});
        }
        return rows;
    }
